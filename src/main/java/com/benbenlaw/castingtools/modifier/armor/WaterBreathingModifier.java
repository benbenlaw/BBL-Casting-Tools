...
public class WaterBreathingModifier extends Modifier {
    ...
    public void onPlayerLimitedTick(PlayerTickEvent.Post event, ItemStack stack, ModifierData data, int toolLevel) {
        ...
        player.addEffect(new MobEffectInstance(MobEffects.WATER_BREATHING, data.additionalValue().get().intValue(), 0, false, false));
