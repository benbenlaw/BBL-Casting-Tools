...
The Upgrader is a powerful block that allows you to upgrade your equipment into new ones. For example, turning a modified Iron Pickaxe into a Modified Diamond Pickaxe. The Upgrader will copy everything from the original item and apply it to the new one. Requires Experience in the tank to use. The Upgrader can use the Molten vairent of the material or the item to make the upgraded item. For example, Molten Diamond or Dimaond can be used to upgrade Equipment to Diamond 

![Example](assets/upgrader_gui.png)
